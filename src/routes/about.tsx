...
const collectionImg = getStorageUrl("nandi/nandi-1.webp");
const storyImg = getStorageUrl("everyday-set-short/everyday-set-short-4.webp");
const detailImg = getStorageUrl("aura-set-long/aura-set-long-2.webp");
